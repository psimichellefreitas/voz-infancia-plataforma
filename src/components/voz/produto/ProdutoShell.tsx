    ...
    <div className="min-h-screen bg-secondary">
      ...
      <main className="pt-16 print:pt-0">
        {loading ? (
          ...
          <>
            <section className="border-b border-border bg-primary text-primary-foreground print:border-none print:bg-transparent print:text-foreground">
              <div className="mx-auto max-w-5xl px-5 py-10 sm:px-8 sm:py-14 print:px-0 print:py-0">
                {backTo && (
                  <Link
                    to={backTo.to as never}
                    search={previewSearch}
                    className="print:hidden mb-5 inline-flex items-center gap-2 text-sm font-semibold text-primary-foreground/80 hover:text-primary-foreground"
                  >
                ...
                {intro && (
                  <p className="mt-4 max-w-2xl text-sm leading-relaxed text-primary-foreground/85 sm:text-base print:text-foreground/80">
                    {intro}
                  </p>
                )}
              </div>
